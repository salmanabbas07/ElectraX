    ...
    <section className="hero">
      <div className="container hero-grid">
        <div className="hero-content">
          ...
          <p>
            Discover premium phones, laptops, gaming gear, audio and smart
            devices built for faster work, better play and cleaner everyday
            living.
          </p>
        ...
        <div className="hero-visual">
          ...
          <div className="float-item phone">
            {" "}
            <FiSmartphone /> Mobiles{" "}
          </div>

          <div className="float-item audio">
            {" "}
